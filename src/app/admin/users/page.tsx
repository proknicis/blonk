        ...
        <div className={styles.dashboard}>
            ...
            <div className={styles.metricsMatrix}>
                ...
                <div className={styles.metricCard}>
                    ...
                    <div className={styles.value}>{new Set(users.map(u => u.firmName)).size}</div>
                ...
                <div className={styles.metricCard}>
                    ...
                    <div className={styles.value}>{users.filter(u => u.role === 'Admin' || u.role === 'SuperAdmin' || u.role === 'OWNER').length}</div>
                ...
                <div className={styles.activeWorkflows} style={{ padding: '32px' }}>
                    ...
                    {isLoading ? (
                        <div style={{ padding: '60px 0', textAlign: 'center' }}>
                            ...
                            <p style={{ fontWeight: 800, color: '#64748B' }}>Accessing identity registry...</p>
                        </div>
                    ) : (
